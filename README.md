...
library that can be embeded into other server applications. The library is not a complete implementation of FHIR, as features that are seolected are driven by the 
