...
func (m *MongoSearchSuite) TestInvalidSearchParameterPanics(c *C) {
	...
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Condition does not support search parameter: abatement`)
}
...
func (m *MongoSearchSuite) TestCompositeSearchPanics(c *C) {
	...
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: composite search parameters`)
}

func (m *MongoSearchSuite) TestPrefixedDateSearchPanics(c *C) {
	q := Query{"Condition", "onset=lt2012"}
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: date search prefix: lt`)
}

func (m *MongoSearchSuite) TestPrefixedNumberSearchPanics(c *C) {
	q := Query{"Immunization", "dose-sequence=gt1"}
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: number search prefix: gt`)
}

func (m *MongoSearchSuite) TestPrefixedQuantitySearchPanics(c *C) {
	q := Query{"Observation", "value-quantity=ap1||mg"}
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: quantity search prefix: ap`)
}

func (m *MongoSearchSuite) TestModifierSearchPanics(c *C) {
	q := Query{"Condition", "code:text=headache"}
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: search modifier: :text`)
}

func (m *MongoSearchSuite) TestChainedSearchPanics(c *C) {
	q := Query{"Condition", "patient.gender=male"}
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: chained search parameters`)
}

func (m *MongoSearchSuite) TestSpecialSearchParameterPanics(c *C) {
	q := Query{"Condition", "onset=2012&_sort:asc=onset"}
	c.Assert(func() { m.MongoSearcher.CreateQuery(q) }, PanicMatches, `Unimplemented: special search parameter: _sort:asc`)
}
