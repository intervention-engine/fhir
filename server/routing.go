...
func RegisterRoutes(e *gin.Engine, config map[string][]gin.HandlerFunc, dal DataAccessLayer, serverConfig Config) {
	...
	RegisterController("OrderSet", e, config["OrderSet"], dal, serverConfig)
	...
	RegisterController("Protocol", e, config["Protocol"], dal, serverConfig)
	...
	RegisterController("ImagingExcerpt", e, config["ImagingExcerpt"], dal, serverConfig)
	RegisterController("MedicationOrder", e, config["MedicationOrder"], dal, serverConfig)
	RegisterController("DecisionSupportRule", e, config["DecisionSupportRule"], dal, serverConfig)
	...
	RegisterController("ModuleDefinition", e, config["ModuleDefinition"], dal, serverConfig)
