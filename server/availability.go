...
func AvailabilityIndexHandler(rw http.ResponseWriter, r *http.Request) {
...
func AvailabilityShowHandler(rw http.ResponseWriter, r *http.Request) {
...
func AvailabilityCreateHandler(rw http.ResponseWriter, r *http.Request) {
...
func AvailabilityDeleteHandler(rw http.ResponseWriter, r *http.Request) {
	var id bson.ObjectId
